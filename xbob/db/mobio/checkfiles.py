...
def add_command(subparsers):
  ...
  parser.add_argument('-u', '--purposes', dest="purposes", default='', help="if given, this value will limit the tested files to those designed for the given purposes. (defaults to '%(default)s')", choices=db.purposes())
  parser.add_argument('-C', '--client', dest="client", default=None, type=int, help="if given, limits the test to a particular client (defaults to '%(default)s')", choices=clients)
  parser.add_argument('-g', '--groups', dest="groups", default='', help="if given, this value will limit the tested files to those belonging to a particular protocolar group. (defaults to '%(default)s')", choices=db.groups())
  parser.add_argument('-c', '--classes', dest="classes", default='', help="if given, this value will limit the tested files to those belonging to the given classes. (defaults to '%(default)s')", choices=('client', 'impostor', ''))
